...
## Active Directory Setup Evidence
...
![AD DS and DNS](Screenshots/02-Server-manager-dns.pngScreenshots/02-server-manager-ad-ds.png)

### Active Directory Domain
The `rizzytech.local` domain was created successfully, with `DC01` configured as the domain controller.
![Active Directory Domain](Screenshots/03-active-directory-domain.png)
...
### Security Groups
Global security groups were created for each department to manage access and permissions through group membership.
...
![AD Users](Screenshots/06-user-1.pngScreenshots/06-user-2.pngScreenshots/06-user-3.pngScreenshots/06-user-4.png)
